...
<PageHeading
	...
	description="Help us reshape education for the better by joining our Board of Advisors. Worldwide (Remote). Volunteer position."
>
...
<div class="p-5 mt-6 rounded-lg bg-indigo-50">
	...
	<TextSection level="2">
		...
		accessibility-related barriers that might restrict participation in our Advisory Board. Our aim
		is to build an inclusive and diverse board, representing a range of backgrounds, experiences,
		and ideas. Therefore, we actively encourage and support applications from all individuals. If
		you encounter any barriers in the application process, we warmly invite you to please share
		these concerns with us. We will treat all such communications with utmost dignity, respect, and
		a commitment to amend and improve our practices.
	</TextSection>
</div>
