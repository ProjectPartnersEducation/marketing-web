	...
	(function (e, t) {
		...
		const Pe = {
			...
			setQualityMenu(e) {
				...
				S.array(e) &&
					(this.options.quality = se(e).filter((e) => this.config.quality.options.includes(e)));
								...
								this.config.settings.forEach((i) => {
									...
									u.appendChild($('span', { 'aria-hidden': !0 }, ve.get(i, this.config))),
										...
										X.call(
											...
											(e) => {
												'ArrowLeft' === e.key &&
													(e.preventDefault(), e.stopPropagation(), o.call(this, 'home', !0));
											},
											!1
										),
										X.call(this, u, 'click', () => {
		...
		const xe = {
				...
				update() {
					...
					this.isHTML5 &&
						...
						this.elements &&
							R(this.elements.container, this.config.classNames.captions.enabled, !S.empty(e)),
						S.array(this.config.controls) &&
							this.config.controls.includes('settings') &&
							this.config.settings.includes('captions') &&
							Pe.setCaptionsMenu.call(this);
				...
				e(this, 'firstTouch', () => {
					...
					e(this, 'media', () => {
						...
						if (
							...
							X.call(e, e.media, 'durationchange loadeddata loadedmetadata', (t) =>
								Pe.durationUpdate.call(e, t)
							),
		...
		function We(e) {
			e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
				this.media.paused === e &&
					((this.media.paused = !e), Z.call(this, this.media, e ? 'play' : 'pause'));
		}
		const ze = {
			setup() {
				const e = this;
				...
				setup() {
					this.media
						? (R(
						  ...
						  this.isEmbed &&
								R(this.elements.container, this.config.classNames.type.replace('{0}', 'video'), !0),
						  this.isVideo &&
			...
			constructor(t) {
				e(this, 'load', () => {
					...
					e(
						...
						'on',
						(e, t) => (
							S.array(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this
						)
					),
		...
		class st {
			constructor(t, i) {
				if (
					...
					e(this, 'pause', () =>
						this.playing && S.function(this.media.pause) ? this.media.pause() : null
					),
					e(this, 'togglePlay', (e) =>
			...
			set quality(e) {
				...
				if (!i.length) return;
				let s = [!S.empty(e) && Number(e), this.storage.get('quality'), t.selected, t.default].find(
						S.number
					),
					n = !0;
				if (!i.includes(s)) {
