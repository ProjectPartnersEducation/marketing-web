...
<div class={additionalClasses}>
	...
	<select
		...
		{id}
		{required}
		class="w-full rounded-md border-0 px-3.5 py-2 pr-10 ring-1 ring-inset focus:ring-2 focus:ring-inset sm:text-2xl sm:leading-6 placeholder:text-gray-400 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200"
		class:pr-10={error}
