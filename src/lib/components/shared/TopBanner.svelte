<script>
	export const title = 'Engaging Education Summit 2023';
	export const description = 'Join us online on August 28th.';
	export const link =
		'https://www.eventbrite.co.uk/e/engaging-education-summit-2023-tickets-635829893327';
	...
	>
		...
		<div class="flex flex-wrap items-center gap-x-4 gap-y-2">
			<p class="text-sm leading-6 text-gray-900">
				<strong class="font-semibold">Engaging Education Summit 2023</strong><svg
					viewBox="0 0 2 2"
					class="mx-2 inline h-0.5 w-0.5 fill-current"
					aria-hidden="true"><circle cx="1" cy="1" r="1" /></svg
				>Join us online on August 28th.
			</p>
			<a
				href={link}
				target="_blank"
